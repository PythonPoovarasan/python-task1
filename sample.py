...
def searchfun():
    ...
    if isvaliduser==False:
        messagebox.showerror("faliure","Please Check Your Registration No and DOB")
    clearfun()
def clearfun():
    t1.delete(0,"end")
    t2.delete(0,"end")
...
l1=tkinter.Label(win,text="SSLC Examination Results  2022",bg="gold")
l1.place(x=300,y=50)

a1=tkinter.Label(win,text="Registration No :",bg="red")
